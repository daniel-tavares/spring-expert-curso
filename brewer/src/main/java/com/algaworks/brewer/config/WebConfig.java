...
@EnableWebMvc
@EnableSpringDataWebSupport // habilita utilização de de Pageable
@EnableCaching
@EnableAsync
...
//        NumberStyleFormatter bigDecilmalFormatter = new NumberStyleFormatter("#,##0.00");
        BigDecimalFormatter bigDecilmalFormatter = new BigDecimalFormatter("#,##0.00");
        conversionService.addFormatterForFieldType(BigDecimal.class, bigDecilmalFormatter);
