...
public class Mailer {
    ...
    public void enviar(Venda venda) {
        ...
        try {
            ...
            helper.setFrom("weliff.14@gmail.com");
            helper.setTo(venda.getCliente().getEmail());
            helper.setSubject(String.format("Brewer - Venda número %d", venda.getCodigo()));
            ...
            for (String cid : fotos.keySet()) {
                ...
                byte[] fotoArray = fotoStorage.recuperarThumbnail(foto);
