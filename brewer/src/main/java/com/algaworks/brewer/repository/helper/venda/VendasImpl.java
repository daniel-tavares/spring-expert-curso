...
public class VendasImpl implements VendasQueries {
    ...
    public BigDecimal valorTotalNoAno() {
        Optional<BigDecimal> totalOptional = Optional.ofNullable(
    ...
    public BigDecimal valorTotalNoMes() {
        Optional<BigDecimal> totalOptional = Optional.ofNullable(
                manager.createQuery("select sum(valorTotal) from Venda where month(dataCriacao) = :mes and year(dataCriacao) = :ano and status = :status", BigDecimal.class)
