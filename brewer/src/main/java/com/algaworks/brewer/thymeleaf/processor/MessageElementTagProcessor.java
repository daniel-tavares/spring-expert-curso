...
public class MessageElementTagProcessor extends AbstractElementTagProcessor{
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
		...
		model.add(modelFactory.createStandaloneElementTag("th:block", "th:replace", "fragments/MessagemSucesso :: mensagem"));
		model.add(modelFactory.createStandaloneElementTag("th:block", "th:replace", "fragments/MessagensErrorValidacao :: mensagem"));
